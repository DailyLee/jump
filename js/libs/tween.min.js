...
var TWEEN = TWEEN || function() {
    ...
    return {
        REVISION: "7", getAll: function() {
            ...
            for (var b = 0, d = a.length, c = void 0 !== c ? c : Date.now(); b < d;) a[b].update(c) ? b++ : (
                a.splice(b, 1), d--);
            return !0
        }
    }
...
TWEEN.Tween = function(a) {
    ...
    this.update = function(e) {
        ...
        !1 === m && (
            null !== l && l.call(a), m = !0);
        var g = (
            e - f) / d, g = 1 < g ? 1 : g, i = h(g), j;
        for (j in c) {
            var s = c[j], q = b[j];
            a[j] = q instanceof Array ? r(q, i) : s + (
                q - s) * i
        }
        null !== n && n.call(a, i);
        if (1 == g) {
...
TWEEN.Easing = {
    Linear: {
        ...
        In: function(a) {
            ...
            return 0 === a ? 0 : 1 === a ? 1 : 1 > (
                a *= 2) ? 0.5 * Math.pow(1024, a - 1) : 0.5 * (
                -Math.pow(2, -10 * (
                    a - 1)) + 2)
        }
    }, Circular: {
        ...
        In: function(a) {
            ...
            !b || 1 > b ? (
                ...
                2 * Math.PI);
            return 1 > (
                a *= 2) ? -0.5 * b * Math.pow(2, 10 * (
                a -= 1)) * Math.sin((
                a - c) * 2 * Math.PI / 0.4) : 0.5 * b * Math.pow(2, -10 * (
                a -= 1)) * Math.sin((
                a - c) * 2 * Math.PI / 0.4) + 1
        }
    }, Back: {
        In: function(a) {
            ...
            return 1 > (
                a *= 2) ? 0.5 * a * a * (
                3.5949095 * a - 2.5949095) : 0.5 * (
                (
                    a -= 2) * a * (
                3.5949095 * a + 2.5949095) + 2)
        }
    }, Bounce: {
        In: function(a) {
            return 1 -
            ...
            return a < 1 / 2.75 ? 7.5625 * a * a : a < 2 / 2.75 ? 7.5625 * (
                ...
                a -= 2.25 / 2.75) * a + 0.9375 : 7.5625 * (
                a -= 2.625 / 2.75) * a + 0.984375
        }, InOut: function(a) {
    ...
    Linear: function(a, c) {
        ...
        return a[0] === a[b] ? (
            0 > c && (
                ...
                e + 1) % b], a[(
                e + 2) % b], d - e)) : 0 > c ? a[0] - (
            f(a[0], a[0], a[1], a[1], -d) - a[0]) : 1 < c ? a[b] - (
            f(a[b], a[b], a[b - 1], a[b - 1], d - b) - a[b]) : f(a[e ? e - 1 : 0], a[e], a[b < e + 1 ? b : e + 1], a[b < e + 2 ? b : e + 2], d - e)
    }, Utils: {
